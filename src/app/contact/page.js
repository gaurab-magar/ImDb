...
const contact = () => {
  ...
  return (
    <motion.div
      ...
      >
    <section className="text-gray-600 dark:text-white body-font relative mt-32">
  <div className="container px-5 py-24 mx-auto">
    <motion.div className="flex flex-col text-center w-full mb-12" variants={itemVariants}>
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 light:text-gray-900">Contact Us</h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify.</p>
    </motion.div>
    <motion.div className="lg:w-1/2 md:w-2/3 mx-auto" variants={itemVariants}>
      <div className="flex flex-wrap -m-2">
        ...
        <motion.div className="p-2 w-1/2" variants={itemVariants}>
        ...
        <motion.div className="p-2 w-full" variants={itemVariants}>
        ...
        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a className="text-blue-500">gdikshan10@gmail.com</a>
