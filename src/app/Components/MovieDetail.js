...
const MovieDetail = ({movie}) => {
  return (
    ...
    >
        <section className="text-gray-600 body-font overflow-hidden mt-32">
            <SearchBox />
        <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-5/5 mx-auto flex flex-wrap">
            <Image className="w-full md:w-1/2 sm:w-full p-2 rounded-2xl duration-200" src={`https://image.tmdb.org/t/p/original/${movie.backdrop_path || movie.poster_path}`} alt="product image" height={150} width={200}/>
