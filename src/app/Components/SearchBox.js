  ...
  return (
    ...
    onSubmit={handleSubmit}  className=" flex items-center max-w-sm mx-auto m-4 px-4">   
            ...
            <div className="w-full">
                <input value={results} onChange={(e)=>{setResults (e.target.value)}}  type="text" id="simple-search" className="outline-none bg-gray-50  text-gray-900 text-base rounded-lg block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search branch name..." required />
            </div>
